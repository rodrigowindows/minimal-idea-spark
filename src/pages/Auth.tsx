...
const titles: Record<AuthMode, { title: string; desc: string }> = {
  login: { title: 'Bem-vindo de volta', desc: 'Entre no seu centro de comando' },
  signup: { title: 'Começar agora', desc: 'Crie sua conta LifeOS' },
  forgot: { title: 'Redefinir senha', desc: 'Informe seu email para receber o link de redefinição' },
};
      ...
      >
        ...
        <div className="text-center space-y-2">
          ...
          <p className="text-sm text-muted-foreground">
            Seu centro de comando pessoal para metas, hábitos e produtividade
          </p>
        </div>
