...
// DB-backed priority functions removed — priorities are now managed via the goals system.
// The Priority interface and local utility functions above remain for RAG context building.
